...
public class DruidDBConfig {
    ...
    public DataSource dataSource() {
        return getDruidDataSource(usernameOne, passwordOne, dbUrlOne);
    }
    ...
    public DataSource secondaryDataSource() {
        return getDruidDataSource(usernameTwo, passwordTwo, dbUrlTwo);
    }
